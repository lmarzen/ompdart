...
#pragma omp target map(to:power[0:array_size]) map(tofrom:result[0:array_size],temp[0:array_size]) firstprivate(row,col,num_iterations,step,Rx_1,Ry_1,Rz_1,Cap_1)
        {
            FLOAT* r = result;
            FLOAT* t = temp;
