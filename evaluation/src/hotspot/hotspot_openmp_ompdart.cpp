...
#pragma omp target map(to:result,temp,power) firstprivate(amb_temp,chunk,r,c,delta,row,col,num_chunk,chunks_in_row,num_iterations,row,col,step,Rx_1,Ry_1,Rz_1,Cap_1)
        {
            FLOAT* r = result;
            FLOAT* t = temp;
